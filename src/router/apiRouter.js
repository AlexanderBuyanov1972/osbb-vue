...
// --------- owner ----------------
export const PAGE_SHOW_OWNER = "/show/owner";
export const PAGE_EDIT_OWNER = "/edit/owner";
export const PAGE_CREATE_OWNER = "/create/owner";
// ---------- ownership ------------------
export const PAGE_SHOW_OWNERSHIP = "/show/ownership";
export const PAGE_EDIT_OWNERSHIP = "/edit/ownership";
export const PAGE_CREATE_OWNERSHIP = "/create/ownership";
// --------- show list ---------------
...
// ---------- entry --------------------
export const PAGE_CREATE_ENTRY_OWNERSHIP = "/create/entry/ownership";
